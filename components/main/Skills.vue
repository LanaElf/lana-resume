<template>
  <section id="skills" class="w-5/6 md:w-4/6">
    ...
    <div>
      <div class="font-bold text-calm press-start-2p text-xs mb-2">Soft</div>

      <ul class="flex flex-col">
        <div>Я свободно, <span class="text-calm">конструктивно</span> и <span class="text-calm">эмпатично</span> взаимодействую с членами команды по решению задач.</div>
        <div><span class="text-calm">Адаптируюсь</span> к изменениям условий, технологического стека и целей продукта.</div>
        <div>Стараюсь <span class="text-calm">критически</span> оценивать ситуацию и принимаемые решения.</div>
        <div>Люблю писать код <span class="text-calm">аккуратно</span>, уделяю внимание мелочам.</div>
        <div><span class="text-calm">Вовлеченно</span> и <span class="text-calm">ответственно</span> подхожу к работе.</div>
      </ul>
    </div>
    ...
    <div class="my-5">
      ...
      <ul class="flex flex-col gap-1">
        ...
        <li>Использую REST API</li>
      </ul>

      <div class="bold text-calm mt-5">Backend</div>

      <div>Пишу пет-проект с AI-агентом на этом стеке, изучая его в процессе:
        <br>Python / FastAPI / MongoDB / REST API / GigaChat API
      </div>
    </div>
    </div>
  </section>
